...
<section class="py-20 bg-gradient-to-b from-brand-50 via-white to-white">
  <div class="max-w-2xl mx-auto px-6 text-center">
    <h1 class="text-3xl md:text-4xl font-extrabold text-slate-900 mb-6">Search</h1>
    <form action="<?= View::url('search') ?>" method="GET" class="flex gap-3">
      <input type="text" name="q" value="<?= View::e($query) ?>" placeholder="Search articles, services, pages..."
             class="flex-1 rounded-full border border-slate-200 px-5 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand-400">
